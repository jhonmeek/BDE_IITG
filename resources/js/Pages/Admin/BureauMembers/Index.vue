        ...
        <div class="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        <tr v-for="member in members" :key="member.id">
                            ...
                            <td class="px-5 py-4 text-right">
                                <a :href="route('admin.bureau-members.edit', member.id)" class="text-amber-700">Modifier</a>
                                <button class="ml-3 text-rose-700" @click="remove(member.id)">Supprimer</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <section class="shell-card p-6">
                ...
                <form class="mt-5 space-y-4" @submit.prevent="submit">
                    ...
                    <textarea v-model="form.bio" rows="4" class="input-shell" placeholder="Presentation" />
